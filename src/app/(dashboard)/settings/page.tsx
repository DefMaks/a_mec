...
export default function SettingsPage() {
  const { roleInfo, role, isTeacher, isParent, isStudent, isAdmin, isSuperAdmin } = useRole();
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                value={
                  isTeacher
                    ? 'shasa.prof@academiedusalut.cd'
                    : isParent
                    ? 'parent.mukendi@gmail.com'
                    : isStudent
                    ? 'joel.eleve@academiedusalut.cd'
                    : 'direction@academiedusalut.cd'
                }
